  ...
  const handleDownload = () => {
    fetch('/Ankush-java-mern-dev.pdf')
      .then((res) => {
        ...
        link.href = '/media/docs/Gaurav-Mahajan-CV.pdf';
        link.download = '/media/docs/Gaurav-Mahajan-CV.pdf';
    ...
    >
      ...
      <div className="md:w-3/5 text-center md:text-left mb-12 md:mb-0 animate-fadeIn z-10">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 leading-tight">
          Hi, I'm <span className="text-purple-400 drop-shadow-[0_0_10px_#a855f7]">Gaurav</span> —
        </h1>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
          Full Stack Developer
        </h2>
        <p className="text-base sm:text-lg text-gray-300 mb-8 max-w-2xl mx-auto md:mx-0">
          Building full stack SaaS products with Java, spring Boot, and SQL — from animated dashboards to secure admin panels and support portals.
        </p>
