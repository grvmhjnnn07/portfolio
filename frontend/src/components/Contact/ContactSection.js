          ...
          <div className="lg:w-1/3">
            <div className="bg-[#1a112b] p-8 rounded-lg border border-purple-800/50 shadow-lg h-full animate-fadeIn">
              ...
              <div className="space-y-6">
                {[
                  { icon: <Mail size={20} className="text-purple-400" />, label: 'Email', value: 'gaurav07mhjn@gmail.com', href: 'mailto:gaurav07mhjn@gmail.com' },
                  { icon: <Phone size={20} className="text-purple-400" />, label: 'Phone', value: '9644391794', href: 'tel:+9644391794' },
                  { icon: <MapPin size={20} className="text-purple-400" />, label: 'Location', value: 'Pune, India' },
                ].map((item, idx) => (
              ...
              <a
                href="/media/docs/Gaurav-Mahajan-CV.pdf"
                download
              ...
              <div className="flex space-x-4">
                {[
                  { icon: <GitHub size={28} />, label: 'GitHub', href: 'https://github.com/' },
                  { icon: <Linkedin size={28} />, label: 'LinkedIn', href: 'https://www.linkedin.com/in/gaurav-mahajan-0a1806310/' },
                  { icon: (
                  ...
                  ), label: 'Instagram', href: 'https://www.instagram.com/grv_mhjnnn07?utm_source=qr&igsh=MWh3bXNkcmN6eWdxMQ==' },
                ].map((social, idx) => (
