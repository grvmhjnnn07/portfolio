  ...
  return (
    <footer className="bg-[#1a112b] text-gray-400 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <Mail size={18} />
              <a
                href="mailto:gaurav07mhjn@gmail.com"
                className="hover:text-purple-400 transition"
              >
                gaurav07mhjn@gmail.com
              </a>
            </div>
            <div className="flex items-center gap-2">
              <Phone size={18} />
              <a
                href="tel:+919644391794"
                className="hover:text-purple-400 transition"
              >
                +91 96443 91794
              </a>
        ...
        <div>
          ...
          <div className="flex gap-4">
            ...
            <a
              href="https://www.linkedin.com/in/gaurav-mahajan-0a1806310/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="hover:text-purple-400 transition"
            ...
            <a
              href="https://www.instagram.com/grv_mhjnnn07?utm_source=qr&igsh=MWh3bXNkcmN6eWdxMQ=="
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className="text-center text-sm text-gray-500 mt-12">
        © {new Date().getFullYear()} CodeGaurav. All rights reserved.
      </div>
    </footer>
  );
};
