    ...
    />
          ...
          <div className="md:w-2/3 text-center md:text-left">
            <p className="text-base sm:text-lg text-gray-300 mb-6">
              I'm a Full Stack Developer passionate about building dynamic, user-friendly web applications. I specialize in the Java Full stack (Java, HTML, CSS, JavaScript) Java/Spring Boot. and have a strong foundation in both frontend and backend development.
            </p>
